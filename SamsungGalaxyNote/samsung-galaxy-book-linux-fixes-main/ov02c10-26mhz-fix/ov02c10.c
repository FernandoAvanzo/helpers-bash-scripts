...
//
// Patched to accept 26 MHz external clock (Raptor Lake IPU6).
// Original only accepts 19.2 MHz. See:
...
MODULE_DESCRIPTION("OmniVision OV02C10 sensor driver (patched: 26 MHz clock support)");
MODULE_LICENSE("GPL");
