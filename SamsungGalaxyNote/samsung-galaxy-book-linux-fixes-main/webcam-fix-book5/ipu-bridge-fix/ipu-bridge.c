...
static const struct dmi_system_id upside_down_sensor_dmi_ids[] = {
	...
	},
	{
		.matches = {
			...
			DMI_EXACT_MATCH(DMI_PRODUCT_NAME, "940XFG"),
		},
		.driver_data = "OVTI02C1",
	},
	{
	...
	},
	{
		.matches = {
			DMI_EXACT_MATCH(DMI_SYS_VENDOR,
					"SAMSUNG ELECTRONICS CO., LTD."),
			DMI_EXACT_MATCH(DMI_PRODUCT_NAME, "960QGK"),
		},
		.driver_data = "OVTI02C1",
	},
	{
	...
	},
	{
		.matches = {
			DMI_EXACT_MATCH(DMI_SYS_VENDOR,
					"SAMSUNG ELECTRONICS CO., LTD."),
			DMI_EXACT_MATCH(DMI_PRODUCT_NAME, "940XHA"),
		},
	...
	},
	{
		.matches = {
			DMI_EXACT_MATCH(DMI_SYS_VENDOR,
					"SAMSUNG ELECTRONICS CO., LTD."),
			DMI_EXACT_MATCH(DMI_PRODUCT_NAME, "960XHA"),
		},
		.driver_data = "OVTI02E1",
	},
	{
