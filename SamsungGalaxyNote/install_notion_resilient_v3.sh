...
#
# Foco desta versão:
# - manter o webapp funcionando de forma confiável;
# - melhorar a integração com o dock/launcher;
# - criar notion.desktop com ícone do Notion;
# - em sessões Wayland, preferir X11 para este launcher por padrão, porque
#   o matching de ícone/janela é mais confiável com WM_CLASS em wrappers manuais.
#
# Compatível com Pop!_OS / Ubuntu / Debian.
#
# Uso:
#   ./install_notion_resilient_v3.sh
#   sudo ./install_notion_resilient_v3.sh --purge-broken
#   ./install_notion_resilient_v3.sh --browser google-chrome-stable
#   ./install_notion_resilient_v3.sh --native-wayland
#   ./install_notion_resilient_v3.sh --software-rendering
...
readonly WM_CLASS="notion-webapp"
...
readonly DEFAULT_ICON_RELATIVE_PATH=".local/share/icons/hicolor/scalable/apps/Notion_app_logo.png"
...
usage() {
  cat <<'EOF'
Uso:
  ./install_notion_resilient_v3.sh [opções]
  sudo ./install_notion_resilient_v3.sh [opções]
...
# Para wrappers manuais, o dock costuma casar melhor o ícone via WM_CLASS em X11.
