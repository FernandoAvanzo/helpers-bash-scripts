...
export COMMAND_RUN="-javaagent:${JAVA_AGENT} -Dfile.encoding=UTF-8 -Dsun.stdout.encoding=UTF-8 -Dsun.stderr.encoding=UTF-8 -classpath ${LOCAL_CLASSPATH}:${KOTLIN_STD_LIB}:${ANNOTATIONS} MainKt"
